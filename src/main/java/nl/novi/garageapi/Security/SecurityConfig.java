    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.PUT,"/autos/**").authenticated()
                        .requestMatchers(HttpMethod.DELETE,"/autos/**").hasAuthority("ADMIN")
                        .requestMatchers(HttpMethod.GET, "/bomedewerkers/{id}").authenticated()
                        .requestMatchers(HttpMethod.GET, "/bomedewerkers").authenticated()
                        ...
                        .requestMatchers(HttpMethod.PUT, "/kassamedewerkers/{id}").hasAuthority("ADMIN")
                        .requestMatchers(HttpMethod.DELETE, "/kassamedewerkers/{id}").hasAuthority("ADMIN")
